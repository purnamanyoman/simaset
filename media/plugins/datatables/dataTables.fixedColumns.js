...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
			...
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;">'+
					...
					'<div class="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;">'+
						'<div class="DTFC_LeftBodyLiner" style="position:relative; top:-5px; left:0;"></div>'+
					'</div>'+
	...
	"_fnGridLayout": function ()
	{
		...
		if ( this.s.iLeftColumns > 0 )
		{
			oGrid.left.wrapper.style.width = (iLeftWidth-1)+"px";
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( dt.aiDisplay.length > 0 )
		{
			...
			for ( iIndex=0 ; iIndex<aiColumns.length ; iIndex++ )
			{
				...
				oStyle.height = 0;
				oStyle.width = (that.s.aiInnerWidths[iColumn]-17)+"px";
