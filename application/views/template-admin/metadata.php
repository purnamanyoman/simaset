...
<!-- Select2 -->
<link href="<?php echo base_url();?>media/plugins/select2/css/select2.css" rel="stylesheet" type="text/css" />
<!-- datepicker -->
...
<script src="<?php echo base_url();?>media/dist/js/demo.min.js" type="text/javascript"></script>
<!-- DATA TABES SCRIPT -->
...
<script src="<?php echo base_url();?>media/plugins/stickytableheaders/jquery.stickytableheaders.js" type="text/javascript"></script>
<!-- slimscroll -->
...
<!-- select2 -->
<script src="<?php echo base_url();?>media/plugins/select2/js/select2.js" type="text/javascript"></script>
<!-- datepicker -->
...
<!-- jquery number -->
<script src="<?php echo base_url();?>media/plugins/jquery-number/jquery.number.min.js" type="text/javascript"></script>
<!-- wyswyg -->
...
<!-- chart -->
<script src="<?php echo base_url();?>media/plugins/chartjs/Chart.min.js" type="text/javascript"></script>
<!-- fileupload -->
