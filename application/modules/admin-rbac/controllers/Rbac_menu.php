...
class Rbac_menu extends CI_Controller {
    ...
    function show_mmenu($id_menu){
        ...
        $arr = array(
            'text'          => $data_menu->text,
            'text_long'     => $data_menu->text_long,
            'text_detail'   => $data_menu->text_detail,
    ...
    function edit_menu($id){
        ...
        $data_post = array(
            ...
            'text_long' => $this->input->post('text_long'),
    ...
    function add_menu(){
        ...
        if ($this->input->post('link')!='#') {
            ...
            $result1 = $this->global_model->general_add($data_post1,'rbac_permissions');
            ...
            $result2 = $this->global_model->general_add($data_post2,'rbac_permissions');
            ...
            $result3 = $this->global_model->general_add($data_post3,'rbac_permissions');
            ...
            $result4 = $this->global_model->general_add($data_post4,'rbac_permissions');
            ...
            $result5 = $this->global_model->general_add($data_post5,'rbac_permissions');
        }
