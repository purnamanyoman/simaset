				...
				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_aset" id="nama_aset" class="form-control" placeholder="" disabled/>
                        </div>
                    </div>		
                </div>
				...
				<div class="row">
                    <div class="col-lg-1">
					   ...
					   <div class="col-lg-3">
                        <div class="form-group">
                            <label>Awal</label>
							  <input type="text" name="tahunpembelian" id="tahunpembelian" class="form-control" placeholder="" disabled/>
                        </div>
                    </div>
					<div class="col-lg-3">
                        <div class="form-group">
