...
<div class="box box-form box-purple" id="<? echo $form_id?>" data-id="<? echo $form_id?>">
  ...
  <form role="form" class="form-input-data animated form-hide form_data_input">
        ...
        <div class="box-body">
            ...
            <fieldset>
      <input type="text" style="display:none;" id="bid" name="bid" value=""/>
<input type="text" style="display:none;" id="kel" name="kel" value=""/>
...
const $kdGol = document.getElementById('kd_gol');
const $kdBid = document.getElementById('kd_bid');
const $kdKel = document.getElementById('kd_kel');
const $kdsKel = document.getElementById('kd_skel');
const $bid = document.getElementById('bid');
$kdGol.onchange = function(e) { 
	$('#kd_bid').find('option:not(:first)').remove();
	$('#kd_kel').find('option:not(:first)').remove();
	$('#kd_skel').find('option:not(:first)').remove();
 
	fetch('<?php echo site_url('aset/barang/get_list_bid');?>', {
		method: 'POST',
	...
	.then(data => {
		document.getElementById('kd_bid').innerHTML = data
	});
		
}

$kdBid.onchange = function(e) {
	 
	fetch('<?php echo site_url('aset/barang/get_list_kel');?>', {
		method: 'POST',
		credentials: 'same-origin',
 
		body: 'bid='+$('#kd_bid').val()+'&gol='+$('#kd_gol').val(),
	})
	.then(response => response.text())
	.then(data => {
		
		document.getElementById('kd_kel').innerHTML = data;
		
	});
}

$kdKel.onchange = function(e) {
	fetch('<?php echo site_url('aset/barang/get_list_skel');?>', {
		method: 'POST',
		credentials: 'same-origin',
	 
		body: 'bid='+$('#kd_bid').val()+'&gol='+$('#kd_gol').val()+'&kel='+$('#kd_kel').val(),
	})
	.then(response => response.text())
	.then(data => {
		document.getElementById('kd_skel').innerHTML = data
	});
}
	...
	fetch('<?php echo site_url('aset/barang/get_list_kel');?>', {
		...
		body: 'bid='+$('#bid').val()+'&gol='+$('#kd_gol').val(),
	})
	.then(response => response.text())
	.then(data => {
		document.getElementById('kd_kel').innerHTML = data;
...
fetch('<?php echo site_url('aset/barang/get_list_skel');?>', {
		...
		body: 'bid='+$('#bid').val()+'&gol='+$('#kd_gol').val()+'&kel='+$('#kel').val(),
	})
	.then(response => response.text())
	.then(data => {
		document.getElementById('kd_skel').innerHTML = data;
