...
<div class="box box-form box-purple" id="<? echo $form_id?>" data-id="<? echo $form_id?>">
  ...
  <form role="form" class="form-input-data animated form-hide form_data_input">
				...
				<div class="row">
					...
					<div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="thn_ang" id="thn_ang" class="form-control" placeholder=""  value="<?php echo $thn_ang;?>"  readonly  />
                        </div>
                    </div>					
                </div>
	<div class="panel panel-info">
		<div class="panel-heading">Rincian Aset</div>
			<div class="panel-body">
				...
				<div class="col-lg-2">
                        <div class="form-group">
                            <label>Nomer aset akhir</label>
                            <input type="text" name="no_aset_akhir" id="no_aset_akhir" class="form-control" placeholder="" />
                        </div>
                    </div>
					  <div class="col-lg-2">
                        <div class="form-group">
                            <label>Jumlah item</label>
                            <input type="text" name="jumlah_item"  onkeyup ="getNUP()" id="jumlah_item" class="form-control"  placeholder=""/>
                        </div>
                    </div>
                    <div class="col-lg-1">
                        <div class="form-group">
                            <label>Nomer urut pendaftaran</label>
					   ...
					   <div class="col-lg-3">
                        <div class="form-group">
                            <label>Awal</label>
							  <input type="text" name="nupawal" id="nupawal" class="form-control" placeholder="" readonly />
                        </div>
                    </div>
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Akhir</label>
							  <input type="text" name="nupakhir" id="nupakhir" class="form-control" placeholder="" readonly />
                        </div>
                    </div>
					...
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Tanggal perolehan</label>
							     <input type="text" name="tgl_perlh" id="tgl_perlh" class="form-control datetimepicker_normal" placeholder="" readonly="" style="cursor: pointer;" />
                        </div>
                    </div>
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Nilai Perolehan</label>
							     <input type="text" name="nilai_aset" id="nilai_aset" class="form-control" placeholder="" readonly="" style="cursor: pointer;" />
                        </div>
                    </div>
                </div> 				
		</div>
	...
	<!--<div class="panel panel-info">
		<div class="panel-heading">Rincian Kapitalisasi</div>
			<div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="kuantitas" id="kuantitas" class="form-control" placeholder=""/>
                        </div>
					</div>	
					<div class="col-lg-6">
                        <div class="form-group">
                            <label>Nilai satuan per item</label>
							  <input type="text" name="nilai_aset" id="nilai_aset" class="form-control" placeholder=""  />
                        </div>
                    </div>
                </div>
 ...
 <div class="panel panel-info">
		<div class="panel-heading">Rincian Lain aset</div>
			<div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>Kondisi aset</label>
                              <select class="input_select form-control" name="kondisi" id="kondisi">
					...
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Tercatat dalam</label>
							       <select class="input_select form-control" name="jns_trn" id="jns_trn">
					...
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Asal perolehan</label>
							        <input type="text" name="asal_perlh" id="asal_perlh" class="form-control" placeholder=""  />
                        </div>
                    </div>
					<div class="col-lg-3">
                        <div class="form-group">
				  ...
				  <div class="row">
					...
					<div class="col-lg-2">
                        <div class="form-group">
                            <label>No. bukti perolehan</label>
							        <input type="text" name="no_bukti" id="no_bukti" class="form-control" placeholder=""  />
                        </div>
                    </div>
					<div class="col-lg-2">
                        <div class="form-group">
                            <label>Merek aset</label>
					...
					<div class="col-lg-2">
                        <div class="form-group">
                            <label>Bahan</label>
							        <input type="text" name="bahan" id="bahan" class="form-control" placeholder=""  />
                        </div>
                    </div>
					<div class="col-lg-1">
                        <div class="form-group">
					...
					<div class="col-lg-1">
                        <div class="form-group">
                            <label>Nomer Rangka</label>
							        <input type="text" name="noRangka" id="noRangka" class="form-control" placeholder=""  />
                        </div>
                    </div>
						<div class="col-lg-1">
                        <div class="form-group">
...
<script type="text/javascript">
		...
		$('.form-input-btn-add').click(function(){
		 ...
		 $("#kd_brg").removeAttr('readonly');
            for (var i = 0; i < arr_file.length; i++) {
				...
				var action = '<?php echo site_url('aset/aset/generate_nomer_sppa');?>';
                ...
                $('#<? echo $form_id?> .form-input-data').ajaxSubmit({
                    ...
                    success: function(data){
						...
						document.getElementsByName("no_sppa")[0].value =data.new_id;
                    }
                });
	...
	function show_cetak_barcode(id){
	   $('#modal-viewprintAll').modal();
       $('#preview').attr('src','<?=base_url('aset/ajax_print_barcode_all');?>'+'/'+id);
     }
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">View Kode Barcode Product</h4>
            ...
            <div class="modal-body">
              <iframe id="preview" name="preview" src="about:blank" frameborder="0" width="100%" height="300"marginheight="0" marginwidth="0"></iframe> 
            </div>
