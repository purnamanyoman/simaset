<div class="box box-form box-purple" id="<? echo $form_id?>" data-id="<? echo $form_id?>">
    <div class="box-header form_data_input_header">
        <h3 class="box-title">
            <div class="btn-group btn-block">
                ...
                <?php if($this->auth->hasPrivilege("DeleteJenisAset")){?><button type="submit" class="btn btn-danger btn-flat btn-sm pull-right form-input-btn-delete form-show animated fadeInLeft" style="margin-right: 10px;"><i class="fa fa-fw fa-times-circle"></i> Hapus</button><?php }?>
                <?php if($this->auth->hasPrivilege("AddJenisAset")){?><button type="submit" class="btn btn-success btn-flat btn-sm pull-right form-input-btn-add form-show animated fadeInLeft"><i class="fa fa-fw fa-file-o"></i> Tambah</button><?php }?>
                ...
                <?php if($this->auth->hasPrivilege("AddJenisAset") || $this->auth->hasPrivilege("EditJenisAset")){?><button type="submit" class="btn btn-success btn-flat btn-sm pull-right form-input-btn-save form-hide"><i class="fa fa-fw fa-save"></i> Simpan</button><?php }?>
            </div>
        </h3>
    </div><!-- /.box-header -->
  ...
  <form role="form" class="form-input-data animated form-hide form_data_input">
        ...
        <div class="box-body">
            <label class="label_fieldset label_fieldset_no_top"><i class="fa fa-fw fa-edit"></i> Info Jenis Aset</label>
            <fieldset>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>Nama jenis aset</label>
                            <input type="text" name="nama_jenisaset" id="nama_jenisaset" class="form-control" placeholder=""/>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="form-group">
                ...
                <table id="<? echo $table_id?>" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="94%">Nama Jenis Aset</th>
