<div class="box box-form box-purple" id="<? echo $form_id?>" data-id="<? echo $form_id?>">
    <div class="box-header form_data_input_header">
        <h3 class="box-title">
            <div class="btn-group btn-block">
                ...
                <?php if($this->auth->hasPrivilege("DeleteGolonganAset")){?><button type="submit" class="btn btn-danger btn-flat btn-sm pull-right form-input-btn-delete form-show animated fadeInLeft" style="margin-right: 10px;"><i class="fa fa-fw fa-times-circle"></i> Hapus</button><?php }?>
                <?php if($this->auth->hasPrivilege("AddGolonganAset")){?><button type="submit" class="btn btn-success btn-flat btn-sm pull-right form-input-btn-add form-show animated fadeInLeft"><i class="fa fa-fw fa-file-o"></i> Tambah</button><?php }?>
                ...
                <?php if($this->auth->hasPrivilege("AddGolonganAset") || $this->auth->hasPrivilege("EditGolonganAset")){?><button type="submit" class="btn btn-success btn-flat btn-sm pull-right form-input-btn-save form-hide"><i class="fa fa-fw fa-save"></i> Simpan</button><?php }?>
            </div>
        </h3>
    </div><!-- /.box-header -->
  ...
  <form role="form" class="form-input-data animated form-hide form_data_input">
        ...
        <div class="box-body">
            <label class="label_fieldset label_fieldset_no_top"><i class="fa fa-fw fa-edit"></i> Info Golongan Aset</label>
            <fieldset>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>Nama Golongan aset</label>
                            <input type="text" name="nama_golongan" id="nama_golongan" class="form-control" placeholder=""/>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="persen_susut" id="persen_susut" class="form-control" placeholder=""/>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>Masa mamfaat</label>
                            <input type="text" name="masa_mamfaat" id="masa_mamfaat" class="form-control" placeholder=""/>
                        </div>
                    </div>
                   ...
                   <div class="col-lg-6">
						<div class="form-group">
                             <label>Jenis aset</label>
                                    <select class="input_select form-control" id="id_jenisaset" name="id_jenisaset">
                                        <? echo $id_jenisaset;?>
									</select>
                        </div>
				   </div>
                ...
                <table id="<? echo $table_id?>" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="94%">Nama Golongan Aset</th>
