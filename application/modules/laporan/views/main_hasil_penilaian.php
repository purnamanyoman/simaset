<div class="box box-success box-solid collapsed-box">
	<div class="box-header with-border">
		<h3 class="box-title">Filter Aset dalam ruangan</h3>
...
<div class="row" id="dataHasil" style="margin-top:20px">
	<div class="col-md-12">
		<div class="box box-form box-purple">
			<div class="box-header with-border">
				<div class="box-title">Laporan aset dalam ruangan</div>
				<div class="box-tools">
...
<script>
	...
	function reload_hasil() {
		...
		$.ajax({			
			...
			url:"<?=base_url()?>laporan/aset_ruangan/reload_hasil",
