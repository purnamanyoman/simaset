...
<div class="box box-form box-purple" id="<? echo $form_id?>" data-id="<? echo $form_id?>">
  ...
  <form role="form" class="form-input-data animated form-hide form_data_input">
		...
		<input type="text" style="display:none;" id="id_status_lamao" name="id_status_lamao" value=""/>
				...
				<div class="row">
                     <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="kd_brg_oto"  onClick="this.select();" id="kd_brg_oto"  class="form-control" placeholder="Scan kode barang dengan barcode reader" readonly   />
					 ...
					 <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="status_lama_oto" id="status_lama_oto" class="form-control" placeholder="" disabled/>
                        </div>
                    </div> 
					 <div class="col-lg-2">
                        <div class="form-group">
                            <label>Set status</label>
                              <select class="input_select form-control"  id="id_status_baru_oto" name="id_status_baru_oto">
                                                <? echo $status;?>
                                            </select>
                        </div>
					</div>
	...
	<div class="panel panel-info">
		<div class="panel-heading">Rubah status aset</div>
			<div class="panel-body">
						<div class="row"> 
                    <div class="col-lg-3">
                        <div class="form-group">
                            <br>
							<label>Nomer aset yang akan dirubah statusnya : </label>
  ...
  <div class="row">
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Tanggal rubah status</label>
							     <input type="text" name="tgl_ubah_status" id="tgl_ubah_status" class="form-control datetimepicker_normal" placeholder=""  style="cursor: pointer;" />
                        </div>
                    </div>
						<div class="col-lg-6">
                        <div class="form-group">
		 	...
		 	<div class="row"> 
                        ...
                        <div class="form-group">
                            <label>Set status</label>
							  <select class="input_select form-control" name="id_status_baru" id="id_status_baru">
                                          <? echo $status;?>
							  </select>
                        </div>
                    </div>
	...
	function detectbarcode(){
       var myid= $("#kodebrg").val();
        ...
        $("#kd_brg_oto").val(myid);
	   	...
	   	$.ajax({
            type: "POST",
            url: "<?php echo site_url('proses/ubah_status/generate_nilai_otomatis');?>",
            data:"id="+myid,
            success: function(data){
				data = JSON.parse(data);
				$("#nama_brg_oto").val(data.nama_brg);
				$("#id_status_lamao").val(data.id_status_lamao);
				$("#no_aseto").val(data.no_aseto);
				$("#kd_brgo").val(data.kd_brgo);
				$("#status_lama_oto").val(data.status_lama_oto);
				$("#id_status_baru_oto option[value='"+data.id_status_lamao+"']").remove();
             },
            error:function(XMLHttpRequest){
                alert(XMLHttpRequest.responseText);
            }
