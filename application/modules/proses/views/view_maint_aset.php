...
<div class="box box-form box-purple" id="<? echo $form_id?>" data-id="<? echo $form_id?>">
  ...
  <form role="form" class="form-input-data animated form-hide form_data_input">
				...
				<div class="row">
                     <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input onClick="this.select();" type="text" name="kd_brg_oto" id="kd_brg_oto"  class="form-control" placeholder="Scan kode barang dengan barcode reader" readonly   />
					 ...
					 <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tempatservis_oto" id="tempatservis_oto" class="form-control" placeholder=""/>
                        </div>
                    </div> 
					 <div class="col-lg-2">
                        <div class="form-group">
                            <label>Biaya servis</label>
                            <input type="text" name="biaya_oto" id="biaya_oto" class="form-control" placeholder=""/>
                        </div>
                    </div> 
                </div>
		</div>
	...
	<div class="panel panel-info">
		<div class="panel-heading">Servis aset</div>
			<div class="panel-body">
				<div class="row"> 
                    <div class="col-lg-3">
                        <div class="form-group"><br>
                            <label>Nomer Aset yang akan dipelihara :</label>
				 ...
				 <div class="col-lg-3">
                        <div class="form-group">
                            <label>Tempat servis</label>
                           <input type="text" name="tempatservis" id="tempatservis" class="form-control" placeholder=""  />
  ...
  <div class="row">
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Tanggal pemeliharaan</label>
							     <input type="text" name="tgl_servis" id="tgl_servis" class="form-control datetimepicker_normal" placeholder=""  style="cursor: pointer;" />
                        </div>
                    </div>
						<div class="col-lg-6">
                        <div class="form-group">
		 	...
		 	<div class="row"> 
                        ...
                        <div class="form-group">
                            <label>Biaya servis</label>
							  <input type="text" name="biaya" id="biaya" class="form-control" placeholder="" maxlength="5" />
                        </div>
                    </div>
					<div class="col-lg-3">
                        <div class="form-group">
                            <label>Keluhan</label>
							  <input type="text" name="keluhan" id="keluhan" class="form-control" placeholder=""  />
                        </div>
                    </div>
                ...
                <table id="<? echo $table_id?>" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">Tanggal Servis</th>
							<th width="10%">Kode barang</th>
							<th width="30%">Nama Barang</th>
							<th width="5%">Nomer Aset</th>
							<th width="20%">Tempat servis</th>
							<th width="20%">Biaya servis</th>
	...
	function detectbarcode(){
       var myid= $("#kodebrg").val(); 
        $("#kd_brg_oto").val(myid);
	   	...
	   	$.ajax({
            type: "POST",
            url: "<?php echo site_url('proses/maintenance/generate_nilai_otomatis');?>",
            data:"id="+myid,
            success: function(data){
